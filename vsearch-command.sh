...
FILES="/storage/MSBvatten/msbvattenJS/SE-2194/190822_A00181_0108_AHLFMYDSXX/Sample*/*R1*"
for f in $FILES; do
  outname=${f##*/}
  outname=${outname%%_*}
  ...
  /home/micke/PycharmProjects/fasta-tools/vsearchjoin_split.py|gzip > $outdir/$outname.fa.gz
done
